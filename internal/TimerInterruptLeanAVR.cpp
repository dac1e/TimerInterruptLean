...
namespace TimerIntLean_ {
  ...
  ISR(TIMER1_OVF_vect) {TimerInterruptLean<1>::isr();}
  ISR(TIMER2_OVF_vect) {TimerInterruptLean<2>::isr();}
  ISR(TIMER3_OVF_vect) {TimerInterruptLean<3>::isr();}
  ISR(TIMER4_OVF_vect) {TimerInterruptLean<4>::isr();}
  ISR(TIMER5_OVF_vect) {TimerInterruptLean<5>::isr();}
