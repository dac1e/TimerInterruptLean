...
namespace TimerIntLean_ {
  ...
  ISR(TIMER1_COMPA_vect) {TimerInterruptLean<1>::isr();}
  ISR(TIMER2_COMPA_vect) {TimerInterruptLean<2>::isr();}
  ISR(TIMER3_COMPA_vect) {TimerInterruptLean<3>::isr();}
  ISR(TIMER4_COMPA_vect) {TimerInterruptLean<4>::isr();}
  ISR(TIMER5_COMPA_vect) {TimerInterruptLean<5>::isr();}
 ...
 */
template<unsigned timerNo> void TimerInterruptLean<timerNo>::init() {
